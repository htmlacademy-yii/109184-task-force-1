    ...
    <header class="page-header">
        <div class="main-container page-header__container">
            ...
            <div class="header__town">
                ...
                <?= AutoComplete::widget([
                    'options'=>[
                      'class' => 'input-middle input hidden mb-0',
                      'autocomplete' => "off",
                      'id' => 'cityInput',
                    ...
                    'clientOptions' => [
                        ...
                        'select' => new JsExpression('function( event, ui ) {
                            ...
                            window.location = "/tasks?city=" + ui.item.value;
                            return false;
                        }'),
                    ],
            ...
            <div class="lightbulb__pop-up" id="lightbulb">
                <container></container>
            </div>
            <div class="header__account">
                ...
                <?= Yii::$app->user->identity->name ?? Yii::$app->user->identity->login; ?>
             </span>
            </div>
