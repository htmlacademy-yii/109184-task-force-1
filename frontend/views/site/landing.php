<div class="landing-container">
   <div class="landing-top">
    <h1>Работа для всех.<br>
       ...
       <a class="button" href="/signup">Создать аккаунт</a>
   </div>
   ...
   <div class="landing-bottom">
       <div class="landing-bottom-container">
           ...
           <?= $this->render('last-tasks', ['tasks' => $tasks]);?>
       </div>
       <div class="landing-bottom-container">
          <a class="button red-button" href="/tasks">смотреть все задания</a>
       </div>
   </div>
</div>
<section class="modal enter-form form-modal" id="enter-form">
    <h2>Вход на сайт</h2>
    <?php echo $this->render('login-modal', ['model' => $model]); ?>
