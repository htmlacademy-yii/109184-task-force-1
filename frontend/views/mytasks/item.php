...
<div class="new-task__card">
    ...
    <div class="feedback-card__top--name my-list__bottom">
      <?php if (isset($task->executant)) { ?>
        <a href="<?= Url::to(['users/view', 'id' => $task->executant->user_id]);?>"><img src="<?= $task->executant->user->avatar || $task->executant->user->avatar != "" ? $task->executant->user->avatar : './img/no-photo.png'?>" width="36" height="36"></a>
